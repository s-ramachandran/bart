...
extern struct linop_s* polyprecond_sense_normal(const struct linop_s* sense_linop_normal, 
												const float* coeffs, 
												const int D, 
												const int N, 
												const long *img_dims);
extern struct linop_s* linop_polyprecond_create(const struct linop_s* sense_linop, 
